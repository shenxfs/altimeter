...
void SettingsDialog::showPortInfo(int idx)
{
    ...
    ui->serialNumberLabel->setText(tr("系列号: %1").arg(list.count() > 3 ? list.at(3) : tr(blankString)));
    ui->locationLabel->setText(tr("位置: %1").arg(list.count() > 4 ? list.at(4) : tr(blankString)));
    ui->vidLabel->setText(tr("生产ID: %1").arg(list.count() > 5 ? list.at(5) : tr(blankString)));
